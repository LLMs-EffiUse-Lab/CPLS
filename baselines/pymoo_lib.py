...
class sms_emoa(object):
    ...
    def run(self):
        ...
        algorithm = SMSEMOA(pop_size=200,
                            crossover=SBX(prob=0.7, eta=26),
                            mutation=PM(prob=0.6, eta=8),
                            sampling=LHS(),
                            )
...
class nsga2(object):
    ...
    def run(self):
        ...
        algorithm = NSGA2(pop_size=200,
                          ...
                          crossover=SBX(prob=0.95, eta=17.0, vtype=int, repair=RoundingRepair()),
                          mutation=PM(prob=0.55, eta=6.0, vtype=int, repair=RoundingRepair()),
