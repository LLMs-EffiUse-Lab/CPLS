...
class CPLS(object):
    ...
    def initialization2_(self):
        ...
        # Generate a list consisting of all 0s
        for i in range(1, 6):
    ...
    def run(self):
        ...
        # Initialize a multiprocessing Pool
        with mp.Pool(processes=n_cpu) as pool:
            # Apply the process_solution function to each solution in parallel
        ...
        nondominated_res = nondominated_res[pareto_efficient_mask]
        # ls_res, ls_solutions = self.fill_gap_multiprocessing(nondominated_res, nondominated_solutions)
        # ls_res, ls_solutions = self.fill_gap_multiprocessing(levels_token, ls_res, ls_solutions)
        ...
        # return ls_res, ls_solutions, elapsed_time
